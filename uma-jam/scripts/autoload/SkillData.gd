...
const ACTIVE_SKILLS: Dictionary = {
	...
	"endurance_recovery": {
		...
		"desc":            "Regen +1 endurance/s for 30s",
		"speed_bonus":     0.0,
		"accel_bonus":     0.0,
		"recovery_bonus":  1,
		"duration":        35.0,
	...
	"speed_while_overtaking": {
		...
		"desc":            "Speed +12 for 5s (while overtaking)",
		"speed_bonus":     12.0,
		"accel_bonus":     0.0,
		"recovery_bonus":  0.0,
		"duration":        5.0,
	...
	"groundwork": {
		...
		"desc":            "Speed +8, Accel +8 for 5s (lap 1 only)",
		"speed_bonus":     5.0,
		"accel_bonus":     20.0,
		"recovery_bonus":  0.0,
		"duration":        5.0,
	...
	"leader_t3_boost": {
		...
		"desc":            "Speed +10, for 10s (1st place at T3)",
		"speed_bonus":     12.0,
		"accel_bonus":     5.0,
		"recovery_bonus":  0.0,
		"duration":        8.0,
	...
	"last_place_t3_boost": {
		...
		"desc":            "Speed +5, Accel +4 for 10s (4th-6th place at T3)",
		"speed_bonus":     30.0,
		"accel_bonus":     15.0,
		"recovery_bonus":  0.0,
		"duration":        10.0,
	...
	"drafting_boost": {
		...
		"desc":            "Speed +3 for 15s (close behind a horse in same lane)",
		"speed_bonus":     3.0,
		"accel_bonus":     0.0,
		"recovery_bonus":  0.0,
		"duration":        15.0,
...
const CHARACTER_PASSIVES: Dictionary = {
	...
	"sakura":          { "label": "Mid-Race Surge",       "desc": "Gains speed while not in 1st place (+15 speed, constant)" },
